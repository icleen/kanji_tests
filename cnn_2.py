...
def main(_):
    ...
    with tf.name_scope('conv_layer1'):
        with tf.name_scope('weights'):
            W_conv1 = weight_variable([kernel_size, kernel_size, 1, 128], "w1")
    ...
    with tf.name_scope('conv_layer2'):
        with tf.name_scope('weights'):
            W_conv2 = weight_variable([kernel_size, kernel_size, 128, 128], "w2")
    ...
    with tf.name_scope('conv_layer3'):
        with tf.name_scope('weights'):
            W_conv3 = weight_variable([kernel_size, kernel_size, 128, 256], "w3")
    ...
    with tf.name_scope('conv_layer4'):
        with tf.name_scope('weights'):
            W_conv4 = weight_variable([kernel_size, kernel_size, 256, 256], "w4")
    ...
    h_pool2_flat = tf.reshape(h_pool4, [-1, 8 * 8 * 256])
